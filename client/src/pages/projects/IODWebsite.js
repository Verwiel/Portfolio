  ...
  return (
    <main className='project-details'>
      ...
      <article>
        ...
        <br />
        <small>I will be uploading code snippets in the future to help give a better understanding of the app.</small>
        <br />
        <small>In the meantime here are links to the <a className='hyper-link' href="https://insideoutdev.com" target="_blank">HubSpot site</a> and the (deprecated) <a className='hyper-link' href="https://dev.insideoutdev.com" target="_blank" rel="noopener noreferrer">initial rebuild</a></small>
        ...
        <div>
          ...
          <ul>
            ...
            <li>Implemented various CRMs to handle our Resources and Blogs (StoryBlok and Strapi respectively). Later moved them over to HubSpot for the marketing team.</li>
